...
\newpage
We know that, for a given probability density function f(x): 
\begin{align}
P\brak{a<X<b} =  \int_{a}^{b} f(x) \,dx 
\end{align}
Probability that the given polynomial has real roots is,

\begin{align}
P\brak{Y \leq -1}+P\brak{Y \geq 2}   
&=  \int_{-\infty}^{-1} f(y) \,dy+\int_{2}^{\infty} f(y) \,dy \\
&= 0+ \int_{2}^{6} f(y) \,dy +0 \\
&= \frac{1}{5} y \Big|_2^6 \\
&= \frac{4}{5} \\
&= 0.8
...
\caption{The figure depicts the PDF of $Y$}
\label{cdf}
\end{figure}
